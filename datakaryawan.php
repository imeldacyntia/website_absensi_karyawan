                ...
                <div class="container-fluid">
                   <ul class="navbar-mobile__list list-unstyled">
                    ...
                    onmouseout="this.style.color='#43766C'; this.style.textDecoration='none'">
                        ...
                        <li>
                            <a href="datakaryawan.php" style="color: #76453B; text-decoration: none;" 
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    ...
                    onmouseout="this.style.textShadow='none'; this.style.color='#76453B'">Admin</h2>
                </a>
            </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <input type="tel" class="form-control" maxlength="9" required="" name="id_karyawan" autocomplete="off" pattern="^\d{1,9}$"title="NIP harus berupa angka dengan maksimal 9 karakter">   
                                                ...
                                                <td>Username</td>
                                                <td>
                                                    <input type="text" class="form-control" required="" name="username" autocomplete="off" pattern="^[^\s]+$" title="Username tidak boleh mengandung spasi">
                                                </td>
                                            ...
                                            <tr>
                                                <td>Password</td>
                                                <td>
                                                <input type="password" class="form-control" required="" name="password" autocomplete="off" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\da-zA-Z]).{6,}$" title="Password harus terdiri dari huruf kecil, huruf besar, angka, tanda baca, minimal 6 karakter">

                                                </td>
                                            </tr>
                                                 <tr>
                                                <td>Nama</td>
                                                <td><input type="text" class="form-control" required="" name="nama" autocomplete="off">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Email</td>
                                                <td>
                                                    <input type="email" class="form-control" required="" name="tmp_tgl_lahir" autocomplete="off" pattern="^[a-zA-Z0-9._%+-]+@gmail.com$" title="Email harus diakhiri dengan @gmail.com">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Jenis Kelamin</td>
                                            ...
                                            <tr>
                                                <td>No Telepon</td>
                                                <td>
                                                    <input type="tel" class="form-control" maxlength="13" required="" name="no_tel" autocomplete="off" pattern="^\d{1,15}$" title="No Telepon harus berupa angka dengan maksimal 13 karakter">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Jabatan</td>
