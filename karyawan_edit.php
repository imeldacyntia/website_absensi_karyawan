...
<form action="proedit_karyawan.php" method="POST" enctype="multipart/form-data">
  ...
  <input type="text" class="form-control"  name="password" autocomplete="off" value="<?php echo $d['password'];?>">
  ...
  <div class="form-group">
    ...
    <input autocomplete="off" class="form-control" name="alamat" value="<?php echo $d['alamat'];?>"></input>
  </div>
    <div class="form-group">
